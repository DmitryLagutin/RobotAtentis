...
# TradingBot
Робот с базовым алгоритмом для торговли на срочном рынке (фьючерсы и опционы) [Московской биржи](https://www.moex.com/ "ссылка на Московскую биржу").
...
+ Производить бэктест ваших стратегий на основе исторических данных брокера.
